...
export type HttpErrorRequestHandler = (
  err: Error,
  req: HttpRequest,
  res: HttpResponse,
  next: HttpNext,
...
export type HttpRequestParamHandler = (
  req: HttpRequest,
  res: HttpResponse,
  next: HttpNext,
  value: any,
...
export type HttpRooterWithHandlerList<T> = (
  path: HttpPathLike,
  ...handlers: Array<HttpRequestHandlerList>
) => T;
...
export interface HttpApplication
  extends EventEmitter, AbstractEventLike<HttpApplication>, HttpRouterSelf, Express.Application {
  // region properties
  _router: any;
  locals: unknown;
  map: any;
...
export type HttpCallLike<C = RecLike> = CoreCallLike<
  C,
  HttpRequest,
  HttpResponse,
  HttpApplication,
