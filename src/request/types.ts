...
export interface HttpRequestLocalsInner<
  C extends HttpContextLike = HttpContextLike,
> extends RecLike {
  context: C;
  base: HttpBaseLike;
  isolated: RecLike;
...
export interface HttpRequest<
  C extends HttpContextLike = HttpContextLike,
  L extends HttpRequestLocals<C> = HttpRequestLocals<C>,
>
  extends
    http.IncomingMessage,
    Express.Request,
    Omit<AbstractEventLike<HttpRequest>, keyof EventEmitter> {
  // region custom
