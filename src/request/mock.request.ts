...
export class MockRequest<B extends RequestBody = RequestBody, L extends RequestLocal = RequestLocal>
  extends HttpEvent<Request>
  implements MockRequestLike<B, L>
{
  // region property
  /** @inheritDoc */
  ...
  constructor(service?: MockServiceRequest<B>, origin?: Request, custom?: Dict) {
    ...
    _attachCustom(this._cast, custom);
    _checkRoute(this._cast);
  }
  /**
   * Cast to express request
   *
   * @return {Request}
   * */
  private get _cast(): Request {
  ...
  compose<T extends NodeJS.ReadableStream>(
    _s: _StreamCompose | Iterable<T> | AsyncIterable<T> | T,
    _o: _StreamAbort | undefined,
  ): T {
